      ...
      <div className="relative z-10 max-w-8xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 py-8 sm:py-12 lg:py-16 xl:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 lg:mb-16">
          <div className="flex items-center justify-center space-x-2 sm:space-x-3 p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/10">
            ...
            <div>
              <h4 className="font-bold text-white text-sm sm:text-base">Belanja Aman</h4>
              <p className="text-slate-400 text-xs sm:text-sm">Dilindungi SSL</p>
            </div>
          </div>
          <div className="flex items-center justify-center space-x-2 sm:space-x-3 p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/10">
            <Award className="h-6 w-6 sm:h-8 sm:w-8 text-amber-400" />
            <div>
              <h4 className="font-bold text-white text-sm sm:text-base">Kualitas Premium</h4>
              <p className="text-slate-400 text-xs sm:text-sm">Produk Bergaransi</p>
            </div>
          </div>
          <div className="flex items-center justify-center space-x-2 sm:space-x-3 p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white/10">
            <Truck className="h-6 w-6 sm:h-8 sm:w-8 text-amber-400" />
            <div>
              <h4 className="font-bold text-white text-sm sm:text-base">Pengiriman Cepat</h4>
              <p className="text-slate-400 text-xs sm:text-sm">Ke Seluruh Indonesia</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
              ...
              />
              <span className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent">BeliBotol</span>
            </div>
            <p className="text-slate-300 mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg leading-relaxed">
              Platform e-commerce profesional yang menghadirkan produk berkualitas premium dengan keandalan yang tak tertandingi dan layanan pelanggan yang luar biasa.
            </p>
          ...
          <div>
            <h3 className="text-base sm:text-lg xl:text-xl font-bold text-white mb-3 sm:mb-4 lg:mb-6">Tautan Cepat</h3>
          ...
          <div>
            <h3 className="text-base sm:text-lg xl:text-xl font-bold text-white mb-3 sm:mb-4 lg:mb-6">Dukungan</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
            ...
            <div className="mt-6 sm:mt-8">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <span className="text-slate-300 font-medium text-sm sm:text-base">support@belibotol.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-700/50 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 sm:space-y-6 lg:space-y-0">
            <p className="text-slate-400 text-center lg:text-left text-xs sm:text-sm">© 2024 BeliBotol. Hak cipta dilindungi. | Dibangun dengan keunggulan untuk e-commerce profesional.</p>
            <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-4 lg:space-x-8">
              <span className="text-slate-400 font-medium text-xs sm:text-sm">Opsi Pembayaran Aman:</span>
              <div className="flex items-center space-x-2 sm:space-x-3">
