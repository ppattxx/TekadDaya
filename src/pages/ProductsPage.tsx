    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 py-6 sm:py-8 lg:py-10 xl:py-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 lg:mb-8 xl:mb-10 gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-slate-900 mb-2 lg:mb-3 xl:mb-4">Products</h1>
            {search && (
          ...
          <div className="flex items-center space-x-3 sm:space-x-4 w-full sm:w-auto justify-between sm:justify-end">
            ...
            <button onClick={() => setShowFilters(!showFilters)} className="lg:hidden flex items-center space-x-2 px-3 sm:px-4 py-2 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors text-sm sm:text-base">
          ...
          <aside className={`lg:w-64 xl:w-72 ${showFilters ? "block" : "hidden lg:block"}`}>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200/50 p-4 sm:p-6 lg:sticky lg:top-24">
              ...
              <div className="mb-6">
                ...
                <select value={sortBy} onChange={(e) => updateFilters("sort", e.target.value)} className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
